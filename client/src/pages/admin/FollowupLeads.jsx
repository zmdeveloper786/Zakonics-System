...
const FollowupLeads = () => {
  ...
  const handleConvert = async (e) => {
    ...
    try {
      await axios.post('http://app.zumarlawfirm.com:5000/convertedService', formData, {
  ...
  const fetchLeads = async () => {
    try {
      const res = await axios.get('http://app.zumarlawfirm.com:5000/leads');
      setLeads(res.data);
    } catch (err) {
      setLeads([]);
    }
  ...
  const handleStatusChange = async (leadId, value) => {
    try {
      await axios.put(`http://app.zumarlawfirm.com:5000/leads/${leadId}/status`, { status: value });
    } catch (err) {}
    setLeads(prev => {
  ...
  const handleEditSave = async () => {
    try {
      await axios.put(`http://app.zumarlawfirm.com:5000/leads/${editModal.lead._id}`, editModal.lead);
  ...
  const handleDeleteLead = async (leadId) => {
    ...
    try {
      await axios.delete(`http://app.zumarlawfirm.com:5000/leads/${leadId}`);
