...
const Roles = () => {
 ...
 const handleDelete = async (id) => {
  ...
  try {
    ...
    await axios.delete(`http://app.zumarlawfirm.com:5000/admin/roles/${id}`, {
      withCredentials: true,
    });
            ...
            <div className="bg-white p-4 rounded shadow mb-6 mt-4">
              ...
              <button
                onClick={async () => {
                  try {
                    setLoading(true);
                    await axios.put(`http://app.zumarlawfirm.com:5000/admin/roles/${editId}`, form, { withCredentials: true });
