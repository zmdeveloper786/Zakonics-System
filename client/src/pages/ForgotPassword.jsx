...
const ForgetPassword = () => {
  ...
  const handleCheckEmail = async () => {
    try {
      const res = await axios.post('http://app.zumarlawfirm.com:5000/auth/forgot-password', { email });
  ...
  const handleResetPassword = async () => {
    try {
      await axios.post('http://app.zumarlawfirm.com:5000/auth/reset-password', {
        email,
        newPassword,
      });
